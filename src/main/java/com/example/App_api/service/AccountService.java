...
public class AccountService {
    ...
    public int verify(String email,String name){
        ...
        String b="<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "                     </tr>\n" +
                "                     <tr style=\"border-collapse:collapse\">\n" +
                "                      <td align=\"center\" style=\"Margin:0;padding-top:10px;padding-bottom:15px;padding-left:20px;padding-right:20px\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'comic sans ms', 'marker felt-thin', arial, sans-serif;line-height:27px;color:#000000;font-size:18px\">Nếu như bạn có bất kỳ câu hỏi nào hoặc không thực hiện yêu cầu này có thể bỏ qua hoặc liên hệ với chúng tôi qua địa chỉ email:&nbsp;<em><strong><a href=\"mailto:travelapp@gmail.com\" target=\"_blank\" style=\"-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#ff0000;font-size:16px\">travelapp@gmail.com</a></strong></em><br>Đây là địa chỉ email tự động, vui lòng không trả lời qua email này!.</p></td>\n" +
                "                     </tr>\n" +
                "                     <tr style=\"border-collapse:collapse\">\n" +
